...
import static forest.colver.datatransfer.azure.ServiceBusOperations.asbConsume;
import static forest.colver.datatransfer.azure.ServiceBusOperations.connect;
...
import static forest.colver.datatransfer.azure.Utils.EMX_SANDBOX_TEST_NAMESPACE;
...
public class AzureEventGridTests {
  ...
  public void testSend() throws IOException {
    ...
    var msg = asbConsume(
        connect(EMX_SANDBOX_TEST_NAMESPACE, EMX_SANDBOX_EVENTGRID_SUBSCRIPTION_QUEUE,
